...
#define PRG_ROM_LOWER_BANK_START 0x8000
#define PRG_ROM_LOWER_BANK_END 0xC000 - 1
#define PRG_ROM_LOWER_BANK_SIZE PRG_ROM_LOWER_BANK_END - PRG_ROM_LOWER_BANK_START 
#define PRG_ROM_UPPER_BANK_START 0xC000
#define PRG_ROM_UPPER_BANK_END 0x10000 - 1
#define PRG_ROM_UPPER_BANK_SIZE PRG_ROM_UPPER_BANK_END - PRG_ROM_UPPER_BANK_START 
